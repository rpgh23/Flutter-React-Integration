...
#ifndef FLUTTER_SHARE_ME_SWIFT_H
#define FLUTTER_SHARE_ME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_share_me",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC16flutter_share_me25SwiftFlutterShareMePlugin")
@interface SwiftFlutterShareMePlugin : NSObject <FBSDKSharingDelegate, FlutterPlugin>
